...
log1b_2 <- glm(won_board_ind ~(investor.number), data = short.data.compust, family = "binomial")
# re_log1b_2   <- sqrt(diag( vcovHC(log1b_2)))
re_log1b_2  = sqrt(diag(  cluster.vcov(log1b_2, short.data.compust$type1) ) )

log1b_3 <- glm(won_board_ind ~(total.activist.number)+log(active.activist.size), data = short.data.compust, family = "binomial")
# re_log1b_3   <- sqrt(diag( vcovHC(log1b_3)))
re_log1b_3  = sqrt(diag(  cluster.vcov(log1b_3, short.data.compust$type1) ) )

log1b_4 <- glm(won_board_ind ~(investor.number)+log(active.activist.size), data = short.data.compust, family = "binomial")
...
log1b_6 <- glm(won_board_ind ~ (total.activist.number)+exit_s_board+exit_s_proxy+log(active.activist.size)+log(active.activist.size)*exit_s_board+log(active.activist.size)*exit_s_proxy, data = short.data.compust, family = "binomial")
# re_log1b_6    <- sqrt(diag( vcovHC(log1b_6)))
re_log1b_6  = sqrt(diag(  cluster.vcov(log1b_6, short.data.compust$type1) ) )

log1b_7 <- glm(won_board_ind ~ (investor.number)+exit_s_board+exit_s_proxy, data = short.data.compust, family = "binomial")
# re_log1b_7    <- sqrt(diag(vcovHC(log1b_7) ))
re_log1b_7  = sqrt(diag(  cluster.vcov(log1b_7, short.data.compust$type1) ) )

log1b_8 <- glm(won_board_ind ~ log(active.activist.size)+(investor.number)+exit_s_board+exit_s_proxy, data = short.data.compust, family = "binomial")
...
log1s_2 <- glm(success_of_stated_obj ~(investor.number), data = short.data.compust, family = "binomial")
# re_log1s_2  <- sqrt(diag( vcovHC(log1s_2)))
re_log1s_2  = sqrt(diag(  cluster.vcov(log1s_2, short.data.compust$type1) ) )


log1s_3 <- glm(success_of_stated_obj ~(total.activist.number)+log(active.activist.size), data = short.data.compust, family = "binomial")
# re_log1s_3  <- sqrt(diag( vcovHC(log1s_3)))
re_log1s_3  = sqrt(diag(  cluster.vcov(log1s_3, short.data.compust$type1) ) )

log1s_4 <- glm(success_of_stated_obj ~(investor.number)+log(active.activist.size), data = short.data.compust, family = "binomial")
...
log1s_6 <- glm(success_of_stated_obj ~ (total.activist.number)+log(active.activist.size)*exit_s_board+log(active.activist.size)*exit_s_proxy, data = short.data.compust, family = "binomial")
# re_log1s_6   <- sqrt(diag( vcovHC(log1s_6) ))
re_log1s_6  = sqrt(diag(  cluster.vcov(log1s_6, short.data.compust$type1) ) )

log1s_7 <- glm(success_of_stated_obj ~ (investor.number)+exit_s_board+exit_s_proxy, data = short.data.compust, family = "binomial")
# re_log1s_7    <- sqrt(diag(vcovHC(log1s_7) ))
re_log1s_7  = sqrt(diag(  cluster.vcov(log1s_7, short.data.compust$type1) ) )

log1s_8 <- glm(success_of_stated_obj ~log(active.activist.size)+(investor.number)+exit_s_board+exit_s_proxy, data = short.data.compust, family = "binomial")
...
ols_1_binar_size <- lm(won_board_ind ~investor.number, data = short.data.compust)
...
ols1_i_cost <- lm(won_board_ind ~ investor.number+exit_s_board+exit_s_proxy, data = short.data.compust)
...
ols1_binar <- lm(won_board_ind ~ total.activist.number+exit_s_board+exit_s_proxy+log(active.activist.size), data = short.data.compust)
...
ols1_binar_investor <- lm(won_board_ind ~ investor.number+log(active.activist.size)+exit_s_board+exit_s_proxy, data = short.data.compust)
...
ols1_binar_controls <- lm(won_board_ind ~ total.activist.number+log(active.activist.size)+exit_s_board+exit_s_proxy+age+log(size)+leverage+mtb, data = short.data.compust)
...
ols_1_classified_size <- lm(success_of_stated_obj ~ investor.number, data = short.data.compust)
...
ols1_i_cost_cl <- lm(success_of_stated_obj ~ investor.number+exit_s_board+exit_s_proxy, data = short.data.compust)
...
ols1_classified <- lm(success_of_stated_obj ~ total.activist.number+exit_s_board+exit_s_proxy+log(active.activist.size), data = short.data.compust)
...
ols1_classified_investor <- lm(success_of_stated_obj ~ investor.number+exit_s_board+exit_s_proxy+log(active.activist.size), data = short.data.compust)
...
ols1_classified_controls <- lm(success_of_stated_obj ~ total.activist.number+exit_s_board+exit_s_proxy+log(active.activist.size)+age+log(size)+leverage+mtb, data = short.data.compust)
...
# Run OLS regressions of type ONE -- with heter robust se's
# 
# ols_1_binar_snum <- lm(won_board_ind ~lag_act_number, data = short.data.compust)
# robust_se_ols_1_binar_snum   <- sqrt(diag( vcovHC(ols_1_binar_snum)))
# 
# ols_1_binar_size <- lm(won_board_ind ~log(active.activist.size)+lag_act_number, data = short.data.compust)
# robust_se_ols_1_binar_size   <- sqrt(diag( vcovHC(ols_1_binar_size)))
# 
# ols1_binar <- lm(won_board_ind ~ log(active.activist.size)+lag_act_number, data = short.data.compust)
# robust_se_ols1_binar   <- sqrt(diag( vcovHC(ols1_binar) ))
# 
# ols1_binar_investor <- lm(won_board_ind ~ log(active.activist.size)+investor.number+lag_act_number, data = short.data.compust)
# robust_se_ols1_binar_investor   <- sqrt(diag( vcovHC(ols1_binar_investor) ))
# 
# ols_1_classified_snum <- lm(success_of_stated_obj ~lag_act_number, data = short.data.compust)
# robust_se_ols_1_classified_snum   <- sqrt(diag( vcovHC(ols_1_classified_snum)))
# 
# ols_1_classified_size <- lm(success_of_stated_obj ~log(active.activist.size)+lag_act_number, data = short.data.compust)
# robust_se_ols_1_classified_size   <- sqrt(diag( vcovHC(ols_1_classified_size)))
# 
# ols1_classified <- lm(success_of_stated_obj ~ log(active.activist.size)+lag_act_number, data = short.data.compust)
# robust_se_ols1_classified   <- sqrt(diag( vcovHC(ols1_classified) ))
# 
# 
# ols1_classified_investor <- lm(success_of_stated_obj ~ log(active.activist.size)+investor.number+lag_act_number, data = short.data.compust)
# robust_se_ols1_classified_investor   <- sqrt(diag(vcovHC(ols1_classified_investor) ))

# # Add controls
# 
# ols1_binar_controls <- lm(won_board_ind ~ log(active.activist.size)+lag_act_number+age+log(size)+leverage+mtb, data = short.data.compust)
# robust_se_ols1_binar_controls   <- sqrt(diag( vcovHC(ols1_binar_controls) ))
# 
# ols1_classified_controls <- lm(success_of_stated_obj ~ log(active.activist.size)+lag_act_number+age+log(size)+leverage+mtb, data = short.data.compust)
# robust_se_ols1_classified_controls   <- sqrt(diag( vcovHC(ols1_classified_controls) ))
# 
# # SECOND c STARGAZER OUTPUT IS HERE
# 
...
# 
# ols1_sales <- lm(sales_growth ~ log(active.activist.size)+total.activist.number+exit_s_board+exit_s_proxy, data = short.data.compust)
# robust_se_ols1_sales   <- sqrt(diag( vcovHC(ols1_sales) ))
# 
# ols1_sales_controls <- lm(sales_growth ~ log(active.activist.size)+total.activist.number+exit_s_board+exit_s_proxy+age+log(size)+leverage+mtb, data = short.data.compust)
# robust_se_ols1_sales_controls   <- sqrt(diag( vcovHC(ols1_sales_controls) ))
# 
# 
# ols1_operat <- lm(oper_profit_growth ~ log(active.activist.size)+exit_s_board+exit_s_proxy+total.activist.number, data = short.data.compust)
# robust_se_ols1_operat    <- sqrt(diag( vcovHC(ols1_operat) ))
# 
# 
# ols1_operat_controls <- lm(oper_profit_growth ~ log(active.activist.size)+total.activist.number+exit_s_board+exit_s_proxy+total.activist.number+age+log(size)+leverage+mtb, data = short.data.compust)
...
ols2d_1 <- lm(won_board_ind ~ log(activist.size.average), data = short.data.compust)
# re_ols2_1    <- sqrt(diag( vcovHC(ols2d_1) ))
re_ols2_1  = sqrt(diag(  cluster.vcov(ols2d_1, short.data.compust$type1) ) )

ols2d_2 <- lm(won_board_ind ~ log(activist.size.vweighted), data = short.data.compust)
# re_ols2_2   <- sqrt(diag( vcovHC(ols2d_2) ))
re_ols2_2  = sqrt(diag(  cluster.vcov(ols2d_2, short.data.compust$type1) ) )

ols2d_3 <- lm(won_board_ind ~ log(activist.size.average)+exit_s_board+exit_s_proxy, data = short.data.compust)
# re_ols2_3    <- sqrt(diag( vcovHC(ols2d_3) ))
re_ols2_3  = sqrt(diag(  cluster.vcov(ols2d_3, short.data.compust$type1) ) )

ols2d_4 <- lm(won_board_ind ~ log(activist.size.vweighted)+exit_s_board+exit_s_proxy, data = short.data.compust)
# re_ols2_4   <- sqrt(diag( vcovHC(ols2d_4) ))
re_ols2_4  = sqrt(diag(  cluster.vcov(ols2d_4, short.data.compust$type1) ) )

ols2d_5 <- lm(won_board_ind ~ log(activist.size.average)+log(active.activist.size), data = short.data.compust)
# re_ols2_5    <- sqrt(diag( vcovHC(ols2d_5) ))
re_ols2_5  = sqrt(diag(  cluster.vcov(ols2d_5, short.data.compust$type1) ) )

ols2d_6 <- lm(won_board_ind ~ log(activist.size.vweighted)+log(active.activist.size), data = short.data.compust)
# re_ols2_6   <- sqrt(diag( vcovHC(ols2d_6) ))
re_ols2_6  = sqrt(diag(  cluster.vcov(ols2d_6, short.data.compust$type1) ) )

ols2d_7 <- lm(won_board_ind ~ log(activist.size.average)+exit_s_board+exit_s_proxy+log(active.activist.size)+age+log(size)+leverage+mtb, data = short.data.compust)
# re_ols2_7   <- sqrt(diag( vcovHC(ols2d_7) ))
re_ols2_7  = sqrt(diag(  cluster.vcov(ols2d_7, short.data.compust$type1) ) )

ols2d_8 <- lm(won_board_ind ~ log(activist.size.vweighted)+exit_s_board+exit_s_proxy+log(active.activist.size)+age+log(size)+leverage+mtb, data = short.data.compust)
# re_ols2_8   <- sqrt(diag( vcovHC(ols2d_8) ))
re_ols2_8  = sqrt(diag(  cluster.vcov(ols2d_8, short.data.compust$type1) ) )

##

ols2s_1 <- lm(success_of_stated_obj ~ log(activist.size.average), data = short.data.compust)
# re_ols2s_1   <- sqrt(diag( vcovHC(ols2s_1) ))
re_ols2s_1  = sqrt(diag(  cluster.vcov(ols2s_1, short.data.compust$type1) ) )

ols2s_2 <- lm(success_of_stated_obj ~ log(activist.size.vweighted), data = short.data.compust)
# re_ols2s_2  <- sqrt(diag( vcovHC(ols2s_2) ))
re_ols2s_2  = sqrt(diag(  cluster.vcov(ols2s_2, short.data.compust$type1) ) )

ols2s_3 <- lm(success_of_stated_obj ~ log(activist.size.average)+exit_s_board+exit_s_proxy, data = short.data.compust)
# re_ols2s_3   <- sqrt(diag( vcovHC(ols2s_3) ))
re_ols2s_3  = sqrt(diag(  cluster.vcov(ols2s_3, short.data.compust$type1) ) )

ols2s_4 <- lm(success_of_stated_obj ~ log(activist.size.vweighted)+exit_s_board+exit_s_proxy, data = short.data.compust)
# re_ols2s_4  <- sqrt(diag( vcovHC(ols2s_4) ))
re_ols2s_4  = sqrt(diag(  cluster.vcov(ols2s_4, short.data.compust$type1) ) )

ols2s_5 <- lm(success_of_stated_obj ~ log(activist.size.average)+log(active.activist.size), data = short.data.compust)
# re_ols2s_5   <- sqrt(diag( vcovHC(ols2s_5) ))
re_ols2s_5  = sqrt(diag(  cluster.vcov(ols2s_5, short.data.compust$type1) ) )

ols2s_6 <- lm(success_of_stated_obj ~ log(activist.size.vweighted)+log(active.activist.size), data = short.data.compust)
# re_ols2s_6  <- sqrt(diag( vcovHC(ols2s_6) ))
re_ols2s_6  = sqrt(diag(  cluster.vcov(ols2s_6, short.data.compust$type1) ) )

ols2s_7 <- lm(success_of_stated_obj ~ log(activist.size.average)+log(active.activist.size)+age+log(size)+leverage+mtb, data = short.data.compust)
# re_ols2s_7  <- sqrt(diag( vcovHC(ols2s_7) ))
re_ols2s_7  = sqrt(diag(  cluster.vcov(ols2s_7, short.data.compust$type1) ) )

ols2s_8 <- lm(success_of_stated_obj ~ log(active.activist.size)+log(activist.size.vweighted)+age+log(size)+leverage+mtb, data = short.data.compust)
# re_ols2s_8 <- sqrt(diag( vcovHC(ols2s_8) ))
re_ols2s_8  = sqrt(diag(  cluster.vcov(ols2s_8, short.data.compust$type1) ) )


# FOURTH A STARGAZER OUTPUT IS HERE
ols2_output = capture.output(stargazer(ols2d_1, ols2d_2, ols2d_3, ols2d_4, ols2d_5,ols2d_6,ols2d_7,ols2d_8,
                                       type = "latex",  
                                       title = "Basic spillower OLS regressions with robust standard errors",
                                       font.size = "scriptsize", float.env="sidewaystable",header = FALSE,
                                       omit.stat=c("f", "ser"),
                                        report = "vct*",
                                       digits = 4,
                                       se=list(re_ols2_1, re_ols2_2,re_ols2_3,re_ols2_4,re_ols2_5,
                                               re_ols2_6,re_ols2_7,re_ols2_8 )))

note.latex <- "\\multicolumn{9}{l} {\\parbox[t]{15cm}{ \\textit{Notes:} OLS regression  of the equation $Y = \\alpha + \\beta x + \\gamma \\bar{x} +controls+\\epsilon$.
...
# FOURTH A STARGAZER OUTPUT IS HERE
ols2_output = capture.output(stargazer(ols2s_1, ols2s_2, ols2s_3, ols2s_4, ols2s_5,ols2s_6,ols2s_7,ols2s_8,
                                       type = "latex",  
                                       title = "Basic spillower OLS regressions with robust standard errors",
                                       font.size = "scriptsize", float.env="sidewaystable",header = FALSE,
                                       omit.stat=c("f", "ser"),
                                        report = "vct*",
                                       digits = 4,
                                       se=list(re_ols2s_1, re_ols2s_2,re_ols2s_3,re_ols2s_4,re_ols2s_5,
                                               re_ols2s_6,re_ols2s_7,re_ols2s_8 )))
...
ols2d_1 <- lm(won_board_ind ~ log(active.activist.share), data = short.data.compust)
# re_ols2_1    <- sqrt(diag( vcovHC(ols2d_1) ))
re_ols2_1  = sqrt(diag(  cluster.vcov(ols2d_1, short.data.compust$type1) ) )

ols2d_2 <- lm(won_board_ind ~ log(activist.share.vweighted), data = short.data.compust)
# re_ols2_2   <- sqrt(diag( vcovHC(ols2d_2) ))
re_ols2_2  = sqrt(diag(  cluster.vcov(ols2d_2, short.data.compust$type1) ) )

ols2d_3 <- lm(won_board_ind ~ log(active.activist.share)+top20_share_nw_s+exit_s_board+exit_s_proxy, data = short.data.compust)
# re_ols2_3    <- sqrt(diag( vcovHC(ols2d_3) ))
re_ols2_3  = sqrt(diag(  cluster.vcov(ols2d_3, short.data.compust$type1) ) )
...
# ------------------------------ OLS weighted by  fund networks go here

ols3d_1 <- lm(won_board_ind ~ log(inv_size_nw_s), data = short.data.compust)
# re_ols3_1    <- sqrt(diag( vcovHC(ols3d_1) ))
re_ols3_1  = sqrt(diag(  cluster.vcov(ols3d_1, short.data.compust$type1) ) )

ols3d_2 <- lm(won_board_ind ~ log(inv_size_nw_spr), data = short.data.compust)
# re_ols3_2   <- sqrt(diag( vcovHC(ols3d_2) ))
re_ols3_2  = sqrt(diag(  cluster.vcov(ols3d_2, short.data.compust$type1) ) )

ols3d_3 <- lm(won_board_ind ~ log(inv_size_nw_s)+exit_s_board+exit_s_proxy, data = short.data.compust)
# re_ols3_3    <- sqrt(diag( vcovHC(ols3d_3) ))
re_ols3_3  = sqrt(diag(  cluster.vcov(ols3d_3, short.data.compust$type1) ) )

ols3d_4 <- lm(won_board_ind ~ log(inv_size_nw_spr)+exit_s_board+exit_s_proxy, data = short.data.compust)
# re_ols3_4   <- sqrt(diag( vcovHC(ols3d_4) ))
re_ols3_4  = sqrt(diag(  cluster.vcov(ols3d_4, short.data.compust$type1) ) )

ols3d_5 <- lm(won_board_ind ~ log(inv_size_nw_s) +act_size_nw_s, data = short.data.compust)
# re_ols3_5    <- sqrt(diag( vcovHC(ols3d_5) ))
re_ols3_5  = sqrt(diag(  cluster.vcov(ols3d_5, short.data.compust$type1) ) )

ols3d_6 <- lm(won_board_ind ~ log(inv_size_nw_spr) + act_size_nw_spr, data = short.data.compust)
# re_ols3_6   <- sqrt(diag( vcovHC(ols3d_6) ))
re_ols3_6  = sqrt(diag(  cluster.vcov(ols3d_6, short.data.compust$type1) ) )

ols3d_7 <- lm(won_board_ind ~ log(inv_size_nw_s) +exit_s_board+exit_s_proxy+act_size_nw_s+age+scale(size)+leverage+mtb, data = short.data.compust)
# re_ols3_7   <- sqrt(diag( vcovHC(ols3d_7) ))
re_ols3_7  = sqrt(diag(  cluster.vcov(ols3d_7, short.data.compust$type1) ) )

ols3d_8 <- lm(won_board_ind ~ log(inv_size_nw_spr)+exit_s_board+exit_s_proxy+ act_size_nw_s +age+scale(size)+leverage+mtb, data = short.data.compust)
# re_ols3_8   <- sqrt(diag( vcovHC(ols3d_8) ))
re_ols3_8  = sqrt(diag(  cluster.vcov(ols3d_8, short.data.compust$type1) ) )
##

ols3ss_1 <- lm(success_of_stated_obj~ log(inv_size_nw_s), data = short.data.compust)
# re_ols3s_1    <- sqrt(diag( vcovHC(ols3ss_1) ))
re_ols3s_1  = sqrt(diag(  cluster.vcov(ols3ss_1, short.data.compust$type1) ) )

ols3ss_2 <- lm(success_of_stated_obj~ log(inv_size_nw_spr), data = short.data.compust)
# re_ols3s_2   <- sqrt(diag( vcovHC(ols3ss_2) ))
re_ols3s_2  = sqrt(diag(  cluster.vcov(ols3ss_2, short.data.compust$type1) ) )

ols3ss_3 <- lm(success_of_stated_obj~ log(inv_size_nw_s)+exit_s_board+exit_s_proxy, data = short.data.compust)
# re_ols3s_3    <- sqrt(diag( vcovHC(ols3ss_3) ))
re_ols3s_3  = sqrt(diag(  cluster.vcov(ols3ss_3, short.data.compust$type1) ) )

ols3ss_4 <- lm(success_of_stated_obj~ log(inv_size_nw_spr)+exit_s_board+exit_s_proxy, data = short.data.compust)
# re_ols3s_4   <- sqrt(diag( vcovHC(ols3ss_4) ))
re_ols3s_4  = sqrt(diag(  cluster.vcov(ols3ss_4, short.data.compust$type1) ) )

ols3ss_5 <- lm(success_of_stated_obj~ log(inv_size_nw_s) +act_size_nw_s, data = short.data.compust)
# re_ols3s_5    <- sqrt(diag( vcovHC(ols3ss_5) ))
re_ols3s_5  = sqrt(diag(  cluster.vcov(ols3ss_5, short.data.compust$type1) ) )

ols3ss_6 <- lm(success_of_stated_obj~ log(inv_size_nw_spr) + act_size_nw_spr, data = short.data.compust)
# re_ols3s_6   <- sqrt(diag( vcovHC(ols3ss_6) ))
re_ols3s_6  = sqrt(diag(  cluster.vcov(ols3ss_6, short.data.compust$type1) ) )

ols3ss_7 <- lm(success_of_stated_obj~ log(inv_size_nw_s) +exit_s_board+exit_s_proxy+act_size_nw_s+age+scale(size)+leverage+mtb, data = short.data.compust)
# re_ols3s_7   <- sqrt(diag( vcovHC(ols3ss_7) ))
re_ols3s_7  = sqrt(diag(  cluster.vcov(ols3ss_7, short.data.compust$type1) ) )

ols3ss_8 <- lm(success_of_stated_obj~ log(inv_size_nw_spr)+exit_s_board+exit_s_proxy+ act_size_nw_s +age+scale(size)+leverage+mtb, data = short.data.compust)
...
ols3d_1 <- lm(won_board_ind ~ (act_num_con), data = short.data.compust)
re_ols3_1    <- sqrt(diag( vcovHC(ols3d_1) ))
# re_ols3_1  = sqrt(diag(  cluster.vcov(ols3d_1, short.data.compust$type1) ) )

ols3d_2 <- lm(won_board_ind ~ (act_s), data = short.data.compust)
re_ols3_2   <- sqrt(diag( vcovHC(ols3d_2) ))
# re_ols3_2  = sqrt(diag(  cluster.vcov(ols3d_2, short.data.compust$type1) ) )

ols3d_3 <- lm(won_board_ind ~ (act_num_con)+exit_s_board+exit_s_proxy, data = short.data.compust)
re_ols3_3    <- sqrt(diag( vcovHC(ols3d_3) ))
# re_ols3_3  = sqrt(diag(  cluster.vcov(ols3d_3, short.data.compust$type1) ) )

ols3d_4 <- lm(won_board_ind ~ (act_s)+exit_s_board+exit_s_proxy, data = short.data.compust)
# re_ols3_4   <- sqrt(diag( vcovHC(ols3d_4) ))
re_ols3_4  = sqrt(diag(  cluster.vcov(ols3d_4, short.data.compust$type1) ) )

ols3d_5 <- lm(won_board_ind ~ (act_num_con) +act_size_nw_s, data = short.data.compust)
# re_ols3_5    <- sqrt(diag( vcovHC(ols3d_5) ))
re_ols3_5  = sqrt(diag(  cluster.vcov(ols3d_5, short.data.compust$type1) ) )

ols3d_6 <- lm(won_board_ind ~ (act_s) + act_size_nw_spr, data = short.data.compust)
# re_ols3_6   <- sqrt(diag( vcovHC(ols3d_6) ))
re_ols3_6  = sqrt(diag(  cluster.vcov(ols3d_6, short.data.compust$type1) ) )

ols3d_7 <- lm(won_board_ind ~ (act_num_con) +exit_s_board+exit_s_proxy+act_size_nw_s+age+scale(size)+leverage+mtb, data = short.data.compust)
# re_ols3_7   <- sqrt(diag( vcovHC(ols3d_7) ))
re_ols3_7  = sqrt(diag(  cluster.vcov(ols3d_7, short.data.compust$type1) ) )

ols3d_8 <- lm(won_board_ind ~ (act_s)+exit_s_board+exit_s_proxy+ act_size_nw_s +age+scale(size)+leverage+mtb, data = short.data.compust)
# re_ols3_8   <- sqrt(diag( vcovHC(ols3d_8) ))
re_ols3_8  = sqrt(diag(  cluster.vcov(ols3d_8, short.data.compust$type1) ) )
##

ols3ss_1 <- lm(success_of_stated_obj~ (act_num_con), data = short.data.compust)
re_ols3s_1    <- sqrt(diag( vcovHC(ols3ss_1) ))
# re_ols3s_1  = sqrt(diag(  cluster.vcov(ols3ss_1, short.data.compust$type1) ) )

ols3ss_2 <- lm(success_of_stated_obj~ (act_s), data = short.data.compust)
re_ols3s_2   <- sqrt(diag( vcovHC(ols3ss_2) ))
# re_ols3s_2  = sqrt(diag(  cluster.vcov(ols3ss_2, short.data.compust$type1) ) )

ols3ss_3 <- lm(success_of_stated_obj~ (act_num_con)+exit_s_board+exit_s_proxy, data = short.data.compust)
re_ols3s_3    <- sqrt(diag( vcovHC(ols3ss_3) ))
# re_ols3s_3  = sqrt(diag(  cluster.vcov(ols3ss_3, short.data.compust$type1) ) )

ols3ss_4 <- lm(success_of_stated_obj~ (act_s)+exit_s_board+exit_s_proxy, data = short.data.compust)
re_ols3s_4   <- sqrt(diag( vcovHC(ols3ss_4) ))
# re_ols3s_4  = sqrt(diag(  cluster.vcov(ols3ss_4, short.data.compust$type1) ) )

ols3ss_5 <- lm(success_of_stated_obj~ (act_num_con) +act_size_nw_s, data = short.data.compust)
re_ols3s_5    <- sqrt(diag( vcovHC(ols3ss_5) ))
# re_ols3s_5  = sqrt(diag(  cluster.vcov(ols3ss_5, short.data.compust$type1) ) )

ols3ss_6 <- lm(success_of_stated_obj~ (act_s) + act_size_nw_spr, data = short.data.compust)
re_ols3s_6   <- sqrt(diag( vcovHC(ols3ss_6) ))
# re_ols3s_6  = sqrt(diag(  cluster.vcov(ols3ss_6, short.data.compust$type1) ) )

ols3ss_7 <- lm(success_of_stated_obj~ (act_num_con) +exit_s_board+exit_s_proxy+act_size_nw_s+age+scale(size)+leverage+mtb, data = short.data.compust)
re_ols3s_7   <- sqrt(diag( vcovHC(ols3ss_7) ))
# re_ols3s_7  = sqrt(diag(  cluster.vcov(ols3ss_7, short.data.compust$type1) ) )

ols3ss_8 <- lm(success_of_stated_obj~ (act_s)+exit_s_board+exit_s_proxy+ act_size_nw_s +age+scale(size)+leverage+mtb, data = short.data.compust)
re_ols3s_8   <- sqrt(diag( vcovHC(ols3ss_8) ))
# re_ols3s_8  = sqrt(diag(  cluster.vcov(ols3ss_8, short.data.compust$type1) ) )
...
ols3d_1 <- lm(won_board_ind ~ (top20_share_nw_s), data = short.data.compust)
re_ols3_1    <- sqrt(diag( vcovHC(ols3d_1) ))
# re_ols3_1  = sqrt(diag(  cluster.vcov(ols3d_1, short.data.compust$type1) ) )

ols3d_2 <- lm(won_board_ind ~ (top20_share_nw_spr), data = short.data.compust)
re_ols3_2   <- sqrt(diag( vcovHC(ols3d_2) ))
# re_ols3_2  = sqrt(diag(  cluster.vcov(ols3d_2, short.data.compust$type1) ) )

ols3d_3 <- lm(won_board_ind ~ (top20_share_nw_s)+exit_s_board+exit_s_proxy, data = short.data.compust)
re_ols3_3    <- sqrt(diag( vcovHC(ols3d_3) ))
# re_ols3_3  = sqrt(diag(  cluster.vcov(ols3d_3, short.data.compust$type1) ) )

ols3d_4 <- lm(won_board_ind ~ (top20_share_nw_spr)+exit_s_board+exit_s_proxy, data = short.data.compust)
re_ols3_4   <- sqrt(diag( vcovHC(ols3d_4) ))
# re_ols3_4  = sqrt(diag(  cluster.vcov(ols3d_4, short.data.compust$type1) ) )

ols3d_5 <- lm(won_board_ind ~ (top20_share_nw_s) +act_size_nw_s, data = short.data.compust)
re_ols3_5    <- sqrt(diag( vcovHC(ols3d_5) ))
# re_ols3_5  = sqrt(diag(  cluster.vcov(ols3d_5, short.data.compust$type1) ) )

ols3d_6 <- lm(won_board_ind ~ (top20_share_nw_spr) + act_size_nw_spr, data = short.data.compust)
re_ols3_6   <- sqrt(diag( vcovHC(ols3d_6) ))
# re_ols3_6  = sqrt(diag(  cluster.vcov(ols3d_6, short.data.compust$type1) ) )

ols3d_7 <- lm(won_board_ind ~ (top20_share_nw_s) +exit_s_board+exit_s_proxy+act_size_nw_s+age+scale(size)+leverage+mtb, data = short.data.compust)
re_ols3_7   <- sqrt(diag( vcovHC(ols3d_7) ))
# re_ols3_7  = sqrt(diag(  cluster.vcov(ols3d_7, short.data.compust$type1) ) )

ols3d_8 <- lm(won_board_ind ~ (top20_share_nw_spr)+exit_s_board+exit_s_proxy+ act_size_nw_spr +age+scale(size)+leverage+mtb, data = short.data.compust)
re_ols3_8   <- sqrt(diag( vcovHC(ols3d_8) ))
# re_ols3_8  = sqrt(diag(  cluster.vcov(ols3d_8, short.data.compust$type1) ) )
##

ols3ss_1 <- lm(success_of_stated_obj~ (top20_share_nw_s), data = short.data.compust)
re_ols3s_1    <- sqrt(diag( vcovHC(ols3ss_1) ))
# re_ols3s_1  = sqrt(diag(  cluster.vcov(ols3ss_1, short.data.compust$type1) ) )

ols3ss_2 <- lm(success_of_stated_obj~ (top20_share_nw_spr), data = short.data.compust)
re_ols3s_2   <- sqrt(diag( vcovHC(ols3ss_2) ))
# re_ols3s_2  = sqrt(diag(  cluster.vcov(ols3ss_2, short.data.compust$type1) ) )

ols3ss_3 <- lm(success_of_stated_obj~ (top20_share_nw_s)+exit_s_board+exit_s_proxy, data = short.data.compust)
re_ols3s_3    <- sqrt(diag( vcovHC(ols3ss_3) ))
# re_ols3s_3  = sqrt(diag(  cluster.vcov(ols3ss_3, short.data.compust$type1) ) )

ols3ss_4 <- lm(success_of_stated_obj~ (top20_share_nw_spr)+exit_s_board+exit_s_proxy, data = short.data.compust)
re_ols3s_4   <- sqrt(diag( vcovHC(ols3ss_4) ))
# re_ols3s_4  = sqrt(diag(  cluster.vcov(ols3ss_4, short.data.compust$type1) ) )

ols3ss_5 <- lm(success_of_stated_obj~ (top20_share_nw_s) +act_size_nw_spr, data = short.data.compust)
re_ols3s_5    <- sqrt(diag( vcovHC(ols3ss_5) ))
# re_ols3s_5  = sqrt(diag(  cluster.vcov(ols3ss_5, short.data.compust$type1) ) )

ols3ss_6 <- lm(success_of_stated_obj~ (top20_share_nw_spr) + act_size_nw_spr, data = short.data.compust)
re_ols3s_6   <- sqrt(diag( vcovHC(ols3ss_6) ))
# re_ols3s_6  = sqrt(diag(  cluster.vcov(ols3ss_6, short.data.compust$type1) ) )

ols3ss_7 <- lm(success_of_stated_obj~ (top20_share_nw_s) +exit_s_board+exit_s_proxy+act_size_nw_spr+age+scale(size)+leverage+mtb, data = short.data.compust)
re_ols3s_7   <- sqrt(diag( vcovHC(ols3ss_7) ))
# re_ols3s_7  = sqrt(diag(  cluster.vcov(ols3ss_7, short.data.compust$type1) ) )

ols3ss_8 <- lm(success_of_stated_obj~ (top20_share_nw_spr)+exit_s_board+exit_s_proxy+ act_size_nw_spr +age+scale(size)+leverage+mtb, data = short.data.compust)
re_ols3s_8   <- sqrt(diag( vcovHC(ols3ss_8) ))
# re_ols3s_8  = sqrt(diag(  cluster.vcov(ols3ss_8, short.data.compust$type1) ) )
...
#----------OLS with networks weighted by investor fund network-----------------
...
ols3d_5 <- lm(won_board_ind ~ log_top20_share_nw_s +log(active.activist.size), data = short.data.compust)
# re_ols3_5    <- sqrt(diag( vcovHC(ols3d_5) ))
re_ols3_5  = sqrt(diag(  cluster.vcov(ols3d_5, short.data.compust$type1) ) )

ols3d_6 <- lm(won_board_ind ~ log_top20_share_nw_spr + log(active.activist.size), data = short.data.compust)
# re_ols3_6   <- sqrt(diag( vcovHC(ols3d_6) ))
re_ols3_6  = sqrt(diag(  cluster.vcov(ols3d_6, short.data.compust$type1) ) )

ols3d_7 <- lm(won_board_ind ~ log_top20_share_nw_s +exit_s_board+exit_s_proxy+ log(active.activist.size) +poison_pill+age+log(size)+leverage+mtb, data = short.data.compust)
# re_ols3_7   <- sqrt(diag( vcovHC(ols3d_7) ))
re_ols3_7  = sqrt(diag(  cluster.vcov(ols3d_7, short.data.compust$type1) ) )

ols3d_8 <- lm(won_board_ind ~ log_top20_share_nw_spr+exit_s_board+exit_s_proxy+ log(active.activist.size) +poison_pill+age+log(size)+leverage+mtb, data = short.data.compust)
# re_ols3_8   <- sqrt(diag( vcovHC(ols3d_8) ))
re_ols3_8  = sqrt(diag(  cluster.vcov(ols3d_8, short.data.compust$type1) ) )
##
...
ols3ss_5 <- lm(success_of_stated_obj~ log_top20_share_nw_spr +log(active.activist.size), data = short.data.compust)
# re_ols3s_5    <- sqrt(diag( vcovHC(ols3ss_5) ))
re_ols3s_5  = sqrt(diag(  cluster.vcov(ols3ss_5, short.data.compust$type1) ) )

ols3ss_6 <- lm(success_of_stated_obj~ log_top20_share_nw_s + log(active.activist.size), data = short.data.compust)
# re_ols3s_6   <- sqrt(diag( vcovHC(ols3ss_6) ))
re_ols3s_6  = sqrt(diag(  cluster.vcov(ols3ss_6, short.data.compust$type1) ) )

ols3ss_7 <- lm(success_of_stated_obj~ log_top20_share_nw_s+ log(active.activist.size) +exit_s_board+exit_s_proxy+poison_pill+age+log(size)+leverage+mtb, data = short.data.compust)
# re_ols3s_7   <- sqrt(diag( vcovHC(ols3ss_7) ))
re_ols3s_7  = sqrt(diag(  cluster.vcov(ols3ss_7, short.data.compust$type1) ) )

ols3ss_8 <- lm(success_of_stated_obj~ log_top20_share_nw_spr +exit_s_board+exit_s_proxy+ log(active.activist.size)+poison_pill+age+log(size)+leverage+mtb, data = short.data.compust)
# re_ols3s_8   <- sqrt(diag( vcovHC(ols3ss_8) ))
re_ols3s_8  = sqrt(diag(  cluster.vcov(ols3ss_8, short.data.compust$type1) ) )
...
# With number 
# 
# centr1b_1 <- lm(won_board_ind ~ act_s_clos+total.activist.number, data = short.data.compust)
# re_centr1b_1   <- sqrt(diag( vcovHC(centr1b_1) ))
# 
# centr1b_2 <- lm(won_board_ind ~ act_s_betw+total.activist.number, data = short.data.compust)
# re_centr1b_2   <- sqrt(diag( vcovHC(centr1b_2) ))
# 
# centr1b_3 <- lm(won_board_ind ~ act_sp_clos+total.activist.number, data = short.data.compust)
# re_centr1b_3   <- sqrt(diag( vcovHC(centr1b_3) ))
# 
# centr1b_4 <- lm(won_board_ind ~ act_sp_betw+total.activist.number, data = short.data.compust)
# re_centr1b_4  <- sqrt(diag( vcovHC(centr1b_4) ))
# 
# 
# centr1s_1 <- lm(success_of_stated_obj ~ act_s_clos+total.activist.number, data = short.data.compust)
# re_centr1s_1   <- sqrt(diag( vcovHC(centr1s_1) ))
# 
# centr1s_2 <- lm(success_of_stated_obj ~ act_s_betw+total.activist.number, data = short.data.compust)
# re_centr1s_2   <- sqrt(diag( vcovHC(centr1s_2) ))
# 
# centr1s_3 <- lm(success_of_stated_obj ~ act_sp_clos+total.activist.number, data = short.data.compust)
# re_centr1s_3   <- sqrt(diag( vcovHC(centr1s_3) ))
# 
# centr1s_4 <- lm(success_of_stated_obj ~ act_sp_betw+total.activist.number, data = short.data.compust)
# re_centr1s_4  <- sqrt(diag( vcovHC(centr1s_4) ))
# 
# 
# ols3_n_output = capture.output( stargazer(centr1b_1,centr1b_2, centr1b_3, centr1b_4, 
#                                           centr1s_1, centr1s_2, centr1s_3, centr1s_4,
#                                           type = "latex",  title = " OLS regressions with centrality measures, robust se",
#                                           header = FALSE,omit.stat=c("f", "ser"), font.size = "tiny", float.env="sidewaystable",
#                                           # report = "vct*"
#                                           digits = 4,
#                                           se=list(re_centr1b_1, re_centr1b_2, re_centr1b_3,re_centr1b_4,
#                                                   re_centr1s_1, re_centr1s_2, re_centr1s_3, re_centr1s_4
#                   )    ) )
# 
# 
# note.latex <- "\\multicolumn{9}{l} {\\parbox[t]{24cm}{ \\footnotesize \\textit{Notes:} OLS regression  of the equation $ Y = \\alpha + \\beta x + \\gamma N +controls+\\epsilon$. The regressions are run using the centrality measures to proxy for persuasiveness of an activist. Centrality is a characteristic of a node that captures the importance of the node position in a network. I use three centrality measures for this analysis. Closeness centrality shows how close each node to any other node. Betweennes centrality captures how well situated a node is in terms of the paths that it lies on. Degree centrality, is defined a the number of links incident to a node. Bonacich centrality is a degree centrality adjusted for the centrality of the neighbours in a network. The centrality measures were computed for both Simple and Spring networks. (By construction, centrality measures for Simple network are identical to the centrality measures of Number of Connections network.) After that I aggregated the centrality measures for each campaign. That is, $act\\_simple\\_closeness$ is a sum of closeness centralities of every active activist participating in a campaign, and $oth\\_simple\\_closeness$ is a sum of closeness centralities of every passive activist that invested in the company but does not participate in a campaign. $total.activist.number$ is the number of passive activist investors that hold shares of the company. 
...
ols3_output = capture.output( stargazer(centr_b_1,centr_b_2,centr_b_3,centr_b_4,
                                        centr_b_5, centr_b_6, centr_b_7, centr_b_8,
                                       ...
                                       se=list(re_centr_b_1, re_centr_b_2, re_centr_b_3, re_centr_b_4,
                                               re_centr_b_5, re_centr_b_6, re_centr_b_7, re_centr_b_8)))
