...
note.latex <- "\\multicolumn{4}{l} {\\parbox[t]{13cm}{ \\textit{Notes:} OLS regression  of the equation $Campaign\\_outcome = \\alpha + \\beta_1Investor\\_importance+ \\beta_2Network\\_support + \\beta_3Activist\\_power + \\beta_4Activist\\_cost + Controls + e$.
